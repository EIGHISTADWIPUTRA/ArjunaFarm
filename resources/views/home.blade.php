<x-main-layout>
    ...
    <section id="about" class="flex flex-col lg:flex-row px-16 lg:px-40 py-8 gap-8 lg:gap-32">
        <div class="flex flex-col md:flex-row lg:flex-col justify-center items-center w-full md:gap-4">
            <img src="{{ asset('/images/logo.png') }}" alt="Logo" class="md:h-[150px] lg:h-[250px] hidden md:block lg:block">
            <img src="{{ asset('/images/text-white.png') }}" alt="Logo Text" class="md:h-[150px] lg:h-[100px] hidden dark:block">
            <img src="{{ asset('/images/text-black.png') }}" alt="Logo Text" class="md:h-[150px] lg:h-[100px] dark:hidden block">
        </div>
            ...
            @foreach ($products as $product)
                <a>
                    <x-product-card xp="" class="w-full h-full">
                        <img src="{{ asset('storage/' . $product->image) }}" alt="Produk" class="object-fill w-full h-[50%] rounded-t-2xl">
